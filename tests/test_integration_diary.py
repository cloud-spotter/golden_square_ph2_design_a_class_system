...
"""
5. Given an instance of DiaryEntry,
...
def test_get_phone_number():
    #phone_book = PhoneBook() # TODO: delete after removing method from PhoneBook
    diary_entry_1 = DiaryEntry("Rang Jo", "Tuesday lunch: Jo's new number 07000000003")

    assert diary_entry_1.get_phone_number() == ["Jo", "07000000003"]

"""
6. After adding contacts to the PhoneBook, 
